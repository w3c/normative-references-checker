...
View.toHTML = function (result) {
  ...
  if (hasDeprecation) {
    output += "<li><a href='#mou'>Not following WHATWG MOU in Use</a></li>";
  }
  ...
  if (hasHTML) {
    output += "<h2 id=MOU>Non-compliant WHAT MOU</h2>";
    output += "<p class=note>The document is linking to documents that aren't compatible with the MoU agreement. Update those links.</p>";
